...
$$
*(Eq. 8.13)* where G_N(e) = set of N-grams of e after lower-casing and punctuation removal; c_T(g) = count of g in T; R8.7 sets N to the 5th-percentile item length in words, clipped to [8, 13] for non-synthetic tasks (the maximum of 13 applies to all).
